   ...
   protected final String id;
     ...
     */
      ...
      public void rent(Driver driver, LocalDateTime startRentTime) throws VehicleAlreadyRentedException{
       if(driver == null || startRentTime==null )throw new IllegalArgumentException();
    ...
    public void returnBack(LocalDateTime rentalEnd) throws InvalidRentingPeriodException, VehicleNotRentedException {
      if(rentalEnd== null) throw new IllegalArgumentException();
      if(rentedBy==null) throw new VehicleNotRentedException();
      if(rentalEnd.isBefore(startRentTime))throw new InvalidRentingPeriodException();
      rentedBy=null;
      startRentTime=null;
    }
